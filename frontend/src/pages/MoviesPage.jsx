  ...
  return (
    <div className="min-h-screen bg-[color:var(--bg)] lg:pl-20">
      ...
      <div className="px-4 sm:px-6 lg:px-10 pt-8 pb-24 lg:pb-12">
        <div className="mb-8">
          <h1 className="text-4xl sm:text-5xl font-bold mb-2 text-[color:var(--fg)]">Films</h1>
        ...
        <div className="sticky top-0 z-30 glass-strong rounded-[var(--radius-lg)] p-4 mb-8 border border-white/10">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <Select value={filters.genre} onValueChange={(value) => handleFilterChange('genre', value)}>
              <SelectTrigger className="glass border-white/10 text-[color:var(--fg)]" data-testid="movies-genre-filter">
            ...
            <Select value={filters.sortBy} onValueChange={(value) => handleFilterChange('sortBy', value)}>
              <SelectTrigger className="glass border-white/10 text-[color:var(--fg)]" data-testid="movies-sort-filter">
